...
class Model(nn.Module):
    def __init__(self, config, load_emb=False, path=None, bias=True, total_tokens=63, depth=12, top_k=8, threshold=1.0):
        super().__init__()
        self.config=config
    ...
    @torch.no_grad()
    def topK_genrate_c2t(self, hidden_states, input_ids, head, logits_processor, c2t_ffn):
        ...
        for i in range(depth):
            ...
            #print("cu_scores",cu_scores.shape)
            ...
            if i == 2 or i == 5 or i == 8 or i == 11:
                ...
                #print("ffn_input",ffn_input.shape)
