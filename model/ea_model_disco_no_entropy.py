...
def load_dynamic_length_model(model_path="/home/zhenghan/work/EAGLE2_Ori/EAGLE/eagle/model/disco_vicuna_0822_no_entropy.pth"):
    # 初始化模型结构
...
class EaModel(nn.Module):
    ...
    def __init__(
        ...
        try:
            ...
            bias = True
        if use_disco:
            self.disco = load_dynamic_length_model()
        if use_eagle3:
