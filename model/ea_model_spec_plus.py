...
def load_dynamic_length_model(model_path="/home/zhenghan/work/SpecDec/GCR1672_EAGLE-main/train_model/spec_0805.pth"):
    # 初始化模型结构
...
class EaModel(nn.Module):
    ...
    def __init__(
        ...
        try:
            ...
            bias = True
        if use_spec_plus:
            self.spec_plus = load_dynamic_length_model()
        if use_eagle3:
